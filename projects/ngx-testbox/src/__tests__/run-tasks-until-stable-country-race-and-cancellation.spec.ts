...
type Country = 'US' | 'DE';
const testIds = ['country', 'format', 'formatOption', 'formatLoading', 'code', 'codeOption', 'codeLoading'] as const;

@Component({
  standalone: true,
  selector: 'app-country-race',
  template: `
    <label>
      Country
...
class CountryRaceComponent {
  ...
  onCountryChange(country: Country) {
    ...
    this.#formatsRequest = this.http
      ...
      .subscribe((formats) => {
        // Cancel-like guard: ignore stale responses.
...
describe('runTasksUntilStable (fakeAsync) - country race cancellation and loading state', () => {
  let fixture: ComponentFixture<CountryRaceComponent>;
  let httpTestingController: HttpTestingController;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [CountryRaceComponent],
  ...
  it('renders only the last selected country even when the first country resolves earlier', fakeAsync(() => {
    fixture = TestBed.createComponent(CountryRaceComponent);
